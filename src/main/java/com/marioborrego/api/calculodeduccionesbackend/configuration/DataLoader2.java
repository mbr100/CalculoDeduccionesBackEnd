...
//                               RetribucionRepository retribucionRepository, PersonalRepository personalRepository) {
//        return args -> {
//
...
//            eco1.setActivo(true);
//
//            // 1️⃣ Creamos el Personal asociado al Economico
//            Personal persona = Personal.builder()
...
//                    .titulacion2("Máster en IA")
//                    .titulacion3("Certificación Scrum")
//                    .titulacion4("Curso de Java Avanzado")
//                    .esPersonalInvestigador(false)
//                    .economico(eco1)  // asignamos economico
//                    .build();
//
//// 2️⃣ Guardamos primero el Personal
//            personalRepository.save(persona);
//
//// 3️⃣ Creamos y guardamos la Retribucion vinculada al Personal
//            Retribucion r = new Retribucion();
//            r.setPersonal(persona);
//            r.setImporteRetribucionNoIT(3000L);
//            retribucionRepository.save(r);
//
//// 4️⃣ Asociamos la retribución al Personal
//            persona.setRetribucion(r);
//            personalRepository.save(persona); // guardamos los cambios en persona
//
//// 5️⃣ Asociamos el Personal al Economico y guardamos
//            eco1.setPersonal(List.of(persona));
//            economicoRepository.save(eco1);
//
//
//
