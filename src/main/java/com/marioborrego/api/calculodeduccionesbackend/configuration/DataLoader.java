...
//
//            // Crear BasesCotizacion vinculada al periodo con los mismos datos que la default
//            BasesCotizacion basesDefault = personal.getBasesCotizacion();
//            BasesCotizacion basesPeriodo = BasesCotizacion.builder()
//                    .persona(personal)
//                    .periodoContrato(periodo)
//                    .basesCotizacionContingenciasComunesEnero(basesDefault.getBasesCotizacionContingenciasComunesEnero())
//                    .basesCotizacionContingenciasComunesFebrero(basesDefault.getBasesCotizacionContingenciasComunesFebrero())
//                    .basesCotizacionContingenciasComunesMarzo(basesDefault.getBasesCotizacionContingenciasComunesMarzo())
//                    .basesCotizacionContingenciasComunesAbril(basesDefault.getBasesCotizacionContingenciasComunesAbril())
//                    .basesCotizacionContingenciasComunesMayo(basesDefault.getBasesCotizacionContingenciasComunesMayo())
//                    .basesCotizacionContingenciasComunesJunio(basesDefault.getBasesCotizacionContingenciasComunesJunio())
//                    .basesCotizacionContingenciasComunesJulio(basesDefault.getBasesCotizacionContingenciasComunesJulio())
//                    .basesCotizacionContingenciasComunesAgosto(basesDefault.getBasesCotizacionContingenciasComunesAgosto())
//                    .basesCotizacionContingenciasComunesSeptiembre(basesDefault.getBasesCotizacionContingenciasComunesSeptiembre())
//                    .basesCotizacionContingenciasComunesOctubre(basesDefault.getBasesCotizacionContingenciasComunesOctubre())
//                    .basesCotizacionContingenciasComunesNoviembre(basesDefault.getBasesCotizacionContingenciasComunesNoviembre())
//                    .basesCotizacionContingenciasComunesDiciembre(basesDefault.getBasesCotizacionContingenciasComunesDiciembre())
//                    .build();
//            // Will be persisted via cascade when periodo is saved
