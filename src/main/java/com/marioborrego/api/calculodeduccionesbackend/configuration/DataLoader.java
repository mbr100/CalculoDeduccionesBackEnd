...
public class DataLoader {
    ...
    public DataLoader(PersonalRepository personalRepository) {
        this.personalRepository = personalRepository;
    }

    @Bean
    CommandLineRunner loadData(EconomicoRepository economicoRepository, PersonalRepository personalRepository, BajaLaboralRepository bajaLaboralRepository) {
        return args -> {
    ...
    private Personal crearEmpleado(PersonalRepository personalRepository,
        ...
        BonificacionesTrabajador bonificaciones = BonificacionesTrabajador.builder()
                .tipoBonificacion(esInvestigador ?
                        TiposBonificacion.BONIFICACION_PERSONAL_INVESTIGADOR :
                        TiposBonificacion.OTRA_BONIFICACION)
                .porcentajeBonificacion(esInvestigador ?
